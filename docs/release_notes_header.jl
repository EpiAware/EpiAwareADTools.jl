...
# those rather than describing a changelog file in the repo. There is no
# such file to keep in step with the tags: a release's notes are written
# on the release.

const RELEASE_NOTES_HEADER = """
```@meta
EditURL = "https://github.com/EpiAware/EpiAwareADTools.jl/releases"
```
