...
EpiAwareADTools.jl composes with Julia's automatic differentiation (AD)
...
[![AD](https://github.com/EpiAware/EpiAwareADTools.jl/actions/workflows/ad.yaml/badge.svg?branch=main)](https://github.com/EpiAware/EpiAwareADTools.jl/actions/workflows/ad.yaml)
