...
```@meta
EditURL = "https://github.com/EpiAware/EpiAwareADTools.jl/blob/main/NEWS.md"
```

# Release notes

EpiAwareADTools.jl follows a hybrid changelog approach:
...
See [GitHub Releases](https://github.com/EpiAware/EpiAwareADTools.jl/releases) for minor/patch
release information.
